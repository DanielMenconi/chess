...
public class Piece {
	...
	public int getCol(int x) {
		return (x + Board.HALF_SQUARE_SIZE)/Board.SQUARE_SIZE; // this is to make that the mouse click is on the center of the piece and not top left
	}
	...
	public boolean isValidSquare(int targetCol, int targetRow) {
		...
		hittingP = getHittingP(targetCol, targetRow); // piece that is "hitting"
